...
import com.smacktalk.main.MessageActivity;
...
public class BluetoothChatService {
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(MessageActivity.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(MessageActivity.TOAST, "Unable to connect device");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(MessageActivity.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(MessageActivity.TOAST, "Device connection was lost");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    mHandler.obtainMessage(MessageActivity.MESSAGE_READ, bytes, -1, buffer)
                            .sendToTarget();
                } catch (IOException e) {
